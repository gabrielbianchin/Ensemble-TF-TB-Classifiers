...
X_train_inv = featuresinv[:5278,:,:]
X_val_inv = featuresinv[5278:,:,:]

y_train_inv = classesinv[:5278,:,:]
y_val_inv = classesinv[5278:,:,:]
...
X_test_inv = featuresinv

y_test_inv = classesinv
...
for i in range(5):
    ...
    np.save('/content/drive/My Drive/embedding/Results/pred-cb513-BRNN-' + str(i+1) + '-option1.npy', p1)
    np.save('/content/drive/My Drive/embedding/Results/pred-cb513-BRNN-' + str(i+1) + '-option1.npy', e1)
    ...
    np.save('/content/drive/My Drive/embedding/Results/pred-cb513-BRNN-' + str(i+1) + '-option2.npy', p2)
    np.save('/content/drive/My Drive/embedding/Results/pred-cb513-BRNN-' + str(i+1) + '-option2.npy', e2)